...
**Active blocker:** SHIP — all 6 tasks GREEN; ready to PR
...
- [x] T04: Partial-state guard — INDEX says queued but spec PHASE != SPEC → leave + warn. Test: `tests/task-004.sh` GREEN. AC4 mapped.
- [x] T05: Idempotence — second run is no-op. Test: `tests/task-005.sh` GREEN. AC5 mapped.
- [x] T06: Doc paragraph in CLAUDE.md (live + templates copy) "Multi-feature parallel work" section naming the migrator + when to run it. No test (doc-only). AC1-AC5 covered indirectly.
