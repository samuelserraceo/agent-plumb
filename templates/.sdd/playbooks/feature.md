...
> **Phase B-0 SKELETON.** Frontmatter is final and authoritative for the v0.8 schema. The prose below is a placeholder — Theme 2 (the playbook refactor) will replace it with the rewritten content from the legacy `profile-feature.md`. Do not treat this prose as canonical until Theme 2 commits.
