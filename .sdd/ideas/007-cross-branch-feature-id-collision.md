...
- The feature in this PR — originally scaffolded as `.sdd/features/008-background-while-waiting/`, renames to `.sdd/features/009-background-while-waiting/` on merge to resolve the collision (concrete example of the friction)
