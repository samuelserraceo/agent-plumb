...
| T232 | Network-surface test — `git diff` of the new hook + resolver adds zero new matches for any of `curl`, `wget`, `http[s]?://`, `nc `, or `socket(`. | AC13 | T221, T223 | `tests/feature-011/T232-no-network.bats` | W3 |
