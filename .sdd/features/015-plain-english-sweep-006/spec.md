...
This is a graph-integrity slug-stub created to resolve the wiki-link to `[[015-plain-english-sweep-006]]` in `.sdd/decisions.md`. The audit-close commit on 2026-05-12 referenced this slug; the actual implementation shipped on main via the corresponding squash-merge PR. See `.sdd/decisions.md` for the canonical record + PR link.
